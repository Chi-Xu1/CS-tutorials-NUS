...
public class RunContest implements IMissionControl {
    ...
    public static void main(String[] args) {
        ...
        //  Feel free to change the test case here.
        //  bitmap is an array of n students where 1 means that the student is a spy
        int[] bitmap = new int[550];
        // bitmap[35] = bitmap[99] = bitmap[203] = bitmap[504] = bitmap[777] = bitmap[990] = 1;
        bitmap[35] = bitmap[99] = bitmap[203] = bitmap[504] = 1;
